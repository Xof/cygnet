...
class ColumnProxy[FT](_InfixOps):
    ...
    proxy attributes without a mypy plugin or codegen.  Users who want
    strict typing can spell the type explicitly:
...
# on T.col is a deferred enhancement, gated on a mypy plugin).
class TableProxy[T]:
